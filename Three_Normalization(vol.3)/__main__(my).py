...
class Main:
    if __name__ == "__main__":
        ...
        '''
        fe = pd.read_csv(data_loc+'Feature_Extraction'+data_format, sep=',', dtype='unicode')
        ...
        for norm in range(0, len(normalization_type)):
            ...
            dw.print_confusion_matrix2(use_model_confusion_matrix, classes_y)
        ...
        for norm in range(0, len(normalization_type)):
            ...
            use_model_confusion_matrix, history = dnn.dnn_model(train_X, train_Y, test_X, test_Y,
                                                                norm_type='mms', classes_y=classes_y)
            dw.print_confusion_matrix2(use_model_confusion_matrix, classes_y)